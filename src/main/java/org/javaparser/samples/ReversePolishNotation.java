...
public class ReversePolishNotation {
    ...
    List initializedAttributeList = new ArrayList();
    ArrayList unitializedAttributeArrayList;
    ...
    public void doIt() {
        this.unitializedAttributeArrayList = new ArrayList();
    }
    public void doItMore() {
        ArrayList localInitializedArrayList = new ArrayList();
        List localUnitializedList;
        localUnitializedList = new ArrayList();
    }
    /**
